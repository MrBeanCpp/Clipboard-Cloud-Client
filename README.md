...
![toast plain text](img/toast_plain_text.png)

### 图片

可显示预览图，点击保存到指定位置

![toast image](img/toast_image.png)

### 超链接检测

支持从文本中检测`http(s)`链接，并展示网站**图标**，点击`Open`按钮在默认浏览器中打开

![toast link](img/toast_text_link.png)

#### 腾讯会议支持

支持从气泡通知直接启动腾讯会议应用（无需打开浏览器）

![toast Tencent Meeting](img/toast_text_link_tm.png)
...
- 原生气泡通知：[mohabouje/WinToast](https://github.com/mohabouje/WinToast)
